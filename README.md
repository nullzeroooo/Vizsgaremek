...
A vizsgaremek beadásaként a kész csomagot **a vizsga előtt minimum 14 nap**pal kell a vizsgabizottsághoz benyújtani **GitHub**, vagy más hasonló szolgáltatás segítségével megosztva. A megosztott anyagnak tartalmaznia kell az alábbiakat:
- A szoftver **forráskód**ja.
- Natív asztali alkalmazások esetén a program **telepítőkészlet**e.
- Az adatbázis **adatbázismodell-diagram**ja.
- Az adatbázis export fájlja (**dump**).
- A szoftveralkalmazás **dokumentáció**ja.
